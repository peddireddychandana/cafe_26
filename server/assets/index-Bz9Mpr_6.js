import { r as reactExports, V as jsxRuntimeExports } from "./server-C0c6tFeu.js";
...
const hero = "/cafe_26/assets/hero-food-DpBPI-Uv.jpg";
const burger = "/cafe_26/assets/burger-D1Es-ObY.jpg";
const pizza = "/cafe_26/assets/pizza-K0tJq8Eb.jpg";
const drinks = "/cafe_26/assets/drinks-Cv6WZOfi.jpg";
...
const ZOMATO$2 = "https://www.zomato.com/proddatur/cafe-26-proddatur-locality/order";
const WA$1 = "https://wa.me/919154622226?text=Hi%20I%20want%20to%20order%20from%20Cafe%2026";
function Hero() {
  const root = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const ctx = gsapWithCSS.context(() => {
      gsapWithCSS.from(".hero-line", { y: 60, opacity: 0, duration: 1, stagger: 0.12, ease: "power4.out" });
      gsapWithCSS.from(".hero-cta", { y: 30, opacity: 0, duration: 0.8, delay: 0.6, stagger: 0.1, ease: "power3.out" });
      gsapWithCSS.from(".float-food", { y: -200, opacity: 0, duration: 1.2, delay: 0.3, stagger: 0.2, ease: "bounce.out" });
    }, root);
    return () => ctx.revert();
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: root, className: "relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-24 pb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 bg-gradient-to-b from-background/60 via-background/80 to-background" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: burger, alt: "", "aria-hidden": true, className: "float-food animate-float-slow absolute top-24 left-[6%] w-24 md:w-36 rounded-2xl shadow-2xl rotate-[-8deg] hidden sm:block" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: pizza, alt: "", "aria-hidden": true, className: "float-food animate-float absolute top-32 right-[6%] w-28 md:w-40 rounded-2xl shadow-2xl rotate-[10deg] hidden sm:block" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: drinks, alt: "", "aria-hidden": true, className: "float-food animate-float-slow absolute bottom-24 left-[10%] w-20 md:w-28 rounded-2xl shadow-2xl rotate-[6deg] hidden md:block" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-line inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full glass text-xs uppercase tracking-[0.25em]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary animate-pulse" }),
        "Proddatur, Andhra Pradesh"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-line text-5xl md:text-7xl lg:text-8xl font-extrabold leading-[1.05] mb-6", children: [
        "Cafe 26",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Street Food" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-line text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10", children: "Wood-fired pizzas, juicy burgers, steamy momos & creamy pastas — premium street flavors served fresh." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#menu", className: "hero-cta inline-flex items-center gap-2 px-7 py-4 rounded-full font-semibold glass hover:bg-primary/15 transition", children: "Explore Menu" })
      ] })
    ] })
  ] });
}
const ZOMATO$1 = "https://www.zomato.com/proddatur/cafe-26-proddatur-locality/order";
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: `fixed top-0 inset-x-0 z-50 transition-all ${scrolled ? "py-3" : "py-5"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between ${scrolled ? "glass rounded-full mx-4 md:mx-auto" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "flex items-center gap-2 font-extrabold text-lg md:text-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid place-items-center w-9 h-9 rounded-full text-primary-foreground font-black", style: { background: "var(--gradient-primary)" }, children: "26" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Cafe ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "26" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-8 text-sm", children: ["menu", "popular", "gallery", "about", "contact"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${s}`, className: "capitalize text-muted-foreground hover:text-foreground transition", children: s }, s)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: ZOMATO$1, target: "_blank", rel: "noopener noreferrer", className: "hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold text-primary-foreground", style: { background: "var(--gradient-primary)" }, children: [
...
const momos = "/cafe_26/assets/momos-QET_iWai.jpg";
const pasta = "/cafe_26/assets/pasta-CuI8NqG3.jpg";
const fries = "/cafe_26/assets/fries-DYyv73jA.jpg";
const categories = ["Burgers", "Pizzas", "Momos", "Pasta", "Drinks"];
const menu = [
  // Burgers
...
const ZOMATO_BASE$1 = "https://www.zomato.com/proddatur/cafe-26-proddatur-locality/order";
const zomatoLinkFor$1 = (name) => `${ZOMATO_BASE$1}?utm_source=cafe26_site&utm_medium=menu_modal&utm_campaign=preselect&search=${encodeURIComponent(name)}#${encodeURIComponent(name.toLowerCase().replace(/\s+/g, "-"))}`;
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-72 md:h-96 overflow-hidden rounded-t-3xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.image, alt: item.name, className: "w-full h-full object-cover", width: 1024, height: 768 }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-6 right-6 flex items-end justify-between gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(VegBadge, { veg: item.veg }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: item.category })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl md:text-4xl font-bold", children: item.name })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-extrabold gradient-text", children: item.price })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 space-y-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: item.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm uppercase tracking-widest text-muted-foreground mb-3", children: "Ingredients" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: item.ingredients.map((ing) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 py-1.5 rounded-full text-sm glass", children: ing }, ing)) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-4 flex items-center justify-between gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm md:text-base text-foreground/90 italic", children: [
                  '"',
                  waMsg,
                  '"'
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: copy, className: "shrink-0 grid place-items-center w-10 h-10 rounded-full bg-primary/15 hover:bg-primary/25 transition", children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-4 h-4" }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: zomatoLinkFor$1(item.name),
                    target: "_blank",
                    rel: "noopener noreferrer",
...
const zomatoLinkFor = (name) => `${ZOMATO_BASE}?utm_source=cafe26_site&utm_medium=menu_card&utm_campaign=preselect&search=${encodeURIComponent(name)}#${encodeURIComponent(name.toLowerCase().replace(/\s+/g, "-"))}`;
gsapWithCSS.registerPlugin(ScrollTrigger);
function MenuSection() {
  const [active, setActive] = reactExports.useState("All");
  const [selected, setSelected] = reactExports.useState(null);
  const gridRef = reactExports.useRef(null);
  const items2 = active === "All" ? menu : menu.filter((m) => m.category === active);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "menu", className: "relative py-24 px-4 md:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-primary mb-3", children: "Our Menu" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold mb-4", children: [
          "Crafted ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "street food" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Tap any dish to explore ingredients & order in seconds." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2 mb-12", children: ["All", ...categories].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setActive(c),
          className: `px-5 py-2.5 rounded-full text-sm font-semibold transition-all ${active === c ? "text-primary-foreground glow-primary" : "glass hover:bg-primary/15"}`,
          style: active === c ? { background: "var(--gradient-primary)" } : {},
          children: c
        },
        c
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: gridRef, className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6", children: items2.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(VegBadge, { veg: item.veg }) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex-1 flex flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelected(item), className: "text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-lg mb-1 group-hover:text-primary transition", children: item.name }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: item.category }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-xl gradient-text", children: item.price })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(MenuModal, { item: selected, onClose: () => setSelected(null) })
  ] });
}
gsapWithCSS.registerPlugin(ScrollTrigger);
const items = [
...
function Popular() {
  ...
  reactExports.useEffect(() => {
    ...
    gsapWithCSS.fromTo(
      ref2.current.querySelectorAll(".pop-card"),
      { opacity: 0, y: 60 },
      {
        opacity: 1,
        y: 0,
        ...
        stagger: 0.12,
        ease: "power3.out",
        scrollTrigger: { trigger: ref2.current, start: "top 80%" }
      }
    );
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "popular", className: "py-24 px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-primary mb-3", children: "Loved by all" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold", children: [
        "Most ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "popular" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: ref2, className: "grid grid-cols-2 lg:grid-cols-4 gap-5", children: items.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pop-card glass rounded-2xl overflow-hidden card-hover", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: it.img, alt: it.name, loading: "lazy", className: "w-full h-full object-cover hover:scale-110 transition duration-700" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", children: it.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "gradient-text font-bold", children: it.price })
      ] })
    ] }, it.name)) })
  ] }) });
}
...
function Gallery() {
  ...
  reactExports.useEffect(() => {
    if (!ref2.current) return;
    gsapWithCSS.fromTo(
      ref2.current.querySelectorAll(".g-img"),
      { opacity: 0, scale: 0.9 },
      {
        opacity: 1,
        scale: 1,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "gallery", className: "py-24 px-4 md:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-primary mb-3", children: "Gallery" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold", children: [
          "From our ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "kitchen" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: ref2, className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: imgs.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setOpen(src), className: "g-img relative overflow-hidden rounded-2xl aspect-square group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, alt: "", loading: "lazy", className: "w-full h-full object-cover transition duration-700 group-hover:scale-110" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/70 to-transparent opacity-0 group-hover:opacity-100 transition" })
      ] }, i)) })
    ] }),
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setOpen(null), className: "fixed inset-0 z-[100] bg-background/90 backdrop-blur-md grid place-items-center p-4 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute top-6 right-6 grid place-items-center w-12 h-12 rounded-full glass", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: open, alt: "", className: "max-w-full max-h-full rounded-2xl" })
    ] })
  ] });
}
gsapWithCSS.registerPlugin(ScrollTrigger);
function About() {
  ...
  reactExports.useEffect(() => {
    if (!ref2.current) return;
    gsapWithCSS.fromTo(
      ref2.current.querySelectorAll(".about-l"),
      { x: -60, opacity: 0 },
      {
        x: 0,
        opacity: 1,
    ...
    gsapWithCSS.fromTo(
      ref2.current.querySelector(".about-r"),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", ref: ref2, className: "py-24 px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-l text-sm uppercase tracking-[0.3em] text-primary mb-3", children: "About us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "about-l text-4xl md:text-5xl font-bold mb-6", children: [
        "A taste of ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "premium" }),
        " street food"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-l text-muted-foreground text-lg leading-relaxed mb-4", children: "Cafe 26 is a premium street food cafe in Proddatur offering delicious pizzas, burgers, sandwiches, pasta, and beverages with quality ingredients at affordable prices." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-l text-muted-foreground leading-relaxed", children: "Every dish is hand-crafted, made-to-order and finished with our signature sauces — bringing big-city flavor to your neighborhood." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-r relative rounded-3xl overflow-hidden aspect-[4/5] glass", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hero, alt: "Cafe 26 food spread", className: "w-full h-full object-cover" }) })
  ] }) });
}
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-primary mb-3", children: "Visit us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold", children: [
        "Come ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "say hi" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-8 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5" }), title: "Address", text: "TB Road, Opposite Eye Hospital, Proddatur, Andhra Pradesh" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919154622226", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5" }), title: "Phone", text: "+91 91546 22226" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5" }), title: "Hours", text: "1:00 PM – 10:30 PM (Daily)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.instagram.com/cafe26_streetfood", target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-5 h-5" }), title: "Instagram", text: "@cafe26_streetfood" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-3xl overflow-hidden min-h-[400px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
...
function Info({ icon, title, text }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid place-items-center w-11 h-11 rounded-full text-primary-foreground shrink-0", style: { background: "var(--gradient-primary)" }, children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: text })
    ] })
  ] });
}
...
function FloatingActions() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed right-4 bottom-20 md:bottom-6 z-40 flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: WA, target: "_blank", rel: "noopener noreferrer", "aria-label": "WhatsApp", className: "grid place-items-center w-14 h-14 rounded-full text-primary-foreground shadow-2xl animate-float", style: { background: "linear-gradient(135deg,#25D366,#128C7E)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-6 h-6" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919154622226", "aria-label": "Call", className: "grid place-items-center w-14 h-14 rounded-full text-primary-foreground shadow-2xl", style: { background: "var(--gradient-primary)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-6 h-6" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: ZOMATO, target: "_blank", rel: "noopener noreferrer", className: "md:hidden fixed bottom-0 inset-x-0 z-40 flex items-center justify-center gap-2 py-4 font-bold text-primary-foreground", style: { background: "var(--gradient-primary)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-5 h-5" }),
      " Order Now on Zomato"
    ] })
  ] });
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-10 px-4 md:px-8 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto text-center text-sm text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-2", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Cafe 26 Street Food · Proddatur, AP"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Crafted with ❤️ for street food lovers" })
  ] }) });
}
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Popular, {}),
