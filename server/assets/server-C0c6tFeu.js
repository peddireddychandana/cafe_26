...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-gyDrgjfM.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-RYAY5WfX.js"),
    import("./start-dGNtjlz-.js"),
...
var ROUTER_BASEPATH = "cafe_26";
var SERVER_FN_BASE = "/cafe_26/_serverFn/";
